...
import Mpizza1 from "../assets/Maxpizza1.png"
import mpizza1 from '../assets/Minipizza1.png'
export default function Popular() {
    return (
        <div>
            <section className='bg-[#1A0803]'>
                <div className='container mx-auto flex flex-col items-center'>
                    <div className="flex justify-center mb-16">
                        <div className="relative w-full max-w-[1348px] rounded-3xl overflow-hidden">
                            <img
                                src={Mpizza1}
                                alt="Pizza"
                                className="  w-full h-[286px] object-cover opacity-70"
                            />
                    ...
                    <div>
                        <div className='flex gap-[22px] pt-[54px]'>
                            <div className="w-[260px] bg-[#2A1208] rounded-[30px] px-6 pt-20 pb-6 text-center relative">
